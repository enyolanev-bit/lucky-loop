...
- Mean runtime relative error above bound: 25.70%
...
|---|---|---|---:|---|---|---:|---|---|
| run_001 | logistic_regression | accuracy around 0.93-0.95 | 0.9510 | no | under 2 | 0.54s | yes | accuracy 0.9510 outside predicted range 0.93-0.95 |
| run_002 | logistic_regression | accuracy around 0.95-0.97 | 0.9790 | no | under 5 | 0.03s | yes | accuracy 0.9790 outside predicted range 0.95-0.97 |
| run_003 | svc | accuracy around 0.96-0.98 | 0.9720 | yes | under 5 | 0.02s | yes |  |
| run_004 | gradient_boosting | accuracy around 0.96-0.98 | 0.9441 | no | under 5 | 0.34s | yes | accuracy 0.9441 outside predicted range 0.96-0.98 |
| run_005 | logistic_regression | accuracy around 0.97-0.98 | 0.9860 | no | under 5 | 0.07s | yes | accuracy 0.9860 outside predicted range 0.97-0.98 |
| run_006 | top_model_verification | accuracy around 0.97-0.99 with variance across seeds | 0.9706 | yes | under 10 | 27.99s | no | runtime 27.99s exceeded predicted 10s |
| run_007 | random_forest | accuracy around 0.96-0.98 | 0.9580 | no | under 5 | 0.25s | yes | accuracy 0.9580 outside predicted range 0.96-0.98 |

## Risk Signals

| Run | Predicted risks | Observed evidence | Risk hit |
|---|---|---|---|
| run_001 | logistic regression without feature scaling may underperform compared to scaled variants; single-run best score may not justify a scientific claim; small-dataset variance could overstate a model win on a single split | accuracy 0.9510 outside predicted range 0.93-0.95 | no |
| run_002 | single-run best score may not justify a scientific claim; label-noise sweeps test claim robustness, not leaderboard performance | accuracy 0.9790 outside predicted range 0.95-0.97 | no |
| run_003 | single-run best score may not justify a scientific claim; SVC with RBF kernel may overfit on small datasets without robustness sweeps | none | no |
| run_004 | single-run best score may not justify a scientific claim; gradient boosting may overfit on small datasets without careful tuning; variance across seeds could affect the observed accuracy | accuracy 0.9441 outside predicted range 0.96-0.98 | no |
