...
|---|---|---|---:|---|---|---:|---|---|
| run_001 | logistic_regression | accuracy around 0.90-0.97 | 0.9510 | yes | under 5 | 0.42s | yes |  |
| run_002 | logistic_regression | accuracy around 0.95-0.98 | 0.9790 | yes | under 5 | 0.01s | yes |  |
| run_003 | svc | accuracy around 0.90-0.99 | 0.9720 | yes | under 10 | 0.02s | yes |  |
| run_004 | random_forest | accuracy around 0.90-0.98 | 0.9580 | yes | under 10 | 0.24s | yes |  |
| run_005 | gradient_boosting | accuracy around 0.90-0.98 | 0.9441 | yes | under 15 | 0.42s | yes |  |
| run_006 | top_model_verification | accuracy around 0.90-0.99 | 0.9636 | yes | under 45 | 35.99s | yes |  |
| run_007 | verification_sweep | accuracy around 0.85-0.98 | 0.9615 | yes | under 35 | 23.80s | yes |  |
