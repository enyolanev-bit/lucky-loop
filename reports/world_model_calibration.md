...
- Runtime interval coverage: 83.33%
- Mean metric absolute error outside interval: 0.0020
- Mean runtime relative error above bound: 2.68%
...
|---|---|---|---:|---|---|---:|---|---|
| run_001 | logistic_regression | accuracy around 0.92-0.96 | 0.9510 | yes | under 5 | 0.49s | yes |  |
...
| run_003 | random_forest | accuracy around 0.94-0.98 | 0.9580 | yes | under 10 | 0.97s | yes |  |
| run_004 | verification_sweep | accuracy around 0.94-0.98 | 0.9615 | yes | under 25 | 29.03s | no | runtime 29.03s exceeded predicted 25s |
| run_005 | gradient_boosting | accuracy around 0.94-0.98 | 0.9510 | yes | under 15 | 0.68s | yes |  |
...
| run_004 | label noise can make small hyperparameter differences non-robust; seed variance may exceed apparent gains | runtime 29.03s exceeded predicted 25s; Measured effect is not larger than inter-seed noise. The report must not oversell this as a robust discovery. | yes |
