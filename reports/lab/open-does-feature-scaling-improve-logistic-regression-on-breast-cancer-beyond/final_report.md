...
- Candidate claim: Feature scaling improves logistic regression performance on breast cancer detection beyond seed noise.
- Falsification condition: No significant improvement in performance metrics after feature scaling.
- Minimum evidence: Statistically significant improvement in performance metrics across multiple seeds.

## Methods

### generated_ml_research_protocol

- Goal: Feature scaling improves logistic regression performance on breast cancer detection beyond seed noise.
- Conditions: decisiontreeclassifier, gradientboostingclassifier, logisticregression, mlpclassifier, randomforestclassifier, svc
...
- **supported**: Feature scaling improves logistic regression performance on breast cancer detection beyond seed noise. Evidence: experiment_008. Reason: The measured effect exceeded seed noise by the support threshold.
