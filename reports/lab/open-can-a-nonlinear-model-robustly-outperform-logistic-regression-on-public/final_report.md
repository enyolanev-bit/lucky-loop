...
- Candidate claim: A Transformer-based model (e.g., HART) robustly outperforms logistic regression on public sensor classification data across repeated seeds.
- Falsification condition: If logistic regression's mean balanced accuracy is within 1% of Transformer's, or if the effect-to-noise ratio is <1.5, the hypothesis is falsified.
- Minimum evidence: One public dataset with 10 seeds, showing Transformer mean balanced accuracy > logistic regression by at least 2% and effect-to-noise ratio >2.

## Methods

### generated_ml_research_protocol

- Goal: A Transformer-based model (e.g., HART) robustly outperforms logistic regression on public sensor classification data across repeated seeds.
- Conditions: gradientboostingclassifier, logisticregression, mlpclassifier, randomforestclassifier, svc
...
- **supported**: A Transformer-based model (e.g., HART) robustly outperforms logistic regression on public sensor classification data across repeated seeds. Evidence: experiment_008. Reason: The measured effect exceeded seed noise by the support threshold.
