...
Research question: Can a nonlinear model robustly outperform logistic regression on public sensor classification data across repeated seeds?
...
- Can a nonlinear model robustly outperform logistic regression on public sensor classification data across repeated seeds?
- nonlinear model robustly outperform logistic regression sensor classification data repeated machine learning classification
- nonlinear model robustly outperform logistic regression sensor classification data repeated logistic regression random forest svm gradient boosting
- nonlinear model robustly outperform logistic regression sensor classification data repeated robustness repeated seeds cross validation
...
|---|---|---|---|
| The literature context must establish whether nonlinear models are actually expected to improve sensor classification over simple baselines. | [arxiv_2409_14508_2024], [arxiv_2604_25452_2026], [arxiv_2008_00235_2020], [arxiv_1511_06663_2015], [arxiv_2209_11750_2022] | `domain_source_coverage` | Compare baseline and nonlinear model families on a dataset selected for the user question. |
| Claims about sensor classification performance require robustness checks across splits or seeds, not a single score. | [arxiv_2409_14508_2024], [arxiv_2604_25452_2026], [arxiv_2008_00235_2020], [arxiv_1511_06663_2015], [arxiv_2209_11750_2022] | `effect_to_noise_ratio` | Run matched repeated-seed comparisons and verify effect size against seed noise. |
