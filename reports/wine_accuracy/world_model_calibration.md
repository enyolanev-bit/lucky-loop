...
- Mean metric absolute error outside interval: 0.0080
...
|---|---|---|---:|---|---|---:|---|---|
| run_001 | logistic_regression | accuracy around 0.90-0.97 | 0.9778 | no | under 5 | 0.61s | yes | accuracy 0.9778 outside predicted range 0.90-0.97 |
...
| run_003 | random_forest | accuracy around 0.90-0.98 | 1.0000 | no | under 10 | 0.88s | yes | accuracy 1.0000 outside predicted range 0.90-0.98 |
| run_004 | svc | accuracy around 0.90-0.99 | 0.9778 | yes | under 10 | 0.01s | yes |  |
| run_005 | verification_sweep | accuracy around 0.85-0.98 | 0.9667 | yes | under 35 | 28.41s | yes |  |
| run_006 | gradient_boosting | accuracy around 0.90-0.98 | 0.9556 | yes | under 15 | 0.63s | yes |  |
...
| run_005 | label noise can make small hyperparameter differences non-robust; seed variance may exceed apparent gains | Measured effect is not larger than inter-seed noise. The report must not oversell this as a robust discovery. | yes |
