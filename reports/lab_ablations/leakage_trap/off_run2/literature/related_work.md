...
Research question: Does feature scaling improve accuracy? ML research validity protocol leakage split metric seed variance
...
- Does feature scaling improve accuracy? ML research validity protocol leakage split metric seed variance
...
| Single-run leaderboard wins can overstate robustness when top models are close across seeds. | [arxiv_2407_18367_2024], [arxiv_2410_07095_2024], [arxiv_2506_01372_2025], [arxiv_2507_02554_2025], [arxiv_2605_08956_2026] | `best_claimable_score` | Detect top observed models, rerun matched seeds, and compare effect size against seed noise. |
...
- Seed-Coder: Let the Code Model Curate Data for Itself (https://arxiv.org/abs/2506.03524v2): low relevance to autonomous research, ML agents, world models, or claim verification; score=2.0
- Systematic Mapping Protocol: Reasoning Algorithms on Feature Model (https://arxiv.org/abs/2103.16325v1): low relevance to autonomous research, ML agents, world models, or claim verification; score=2.0
...
- SciFact-Open: Towards open-domain scientific claim verification (https://arxiv.org/abs/2210.13777v1): low relevance to autonomous research, ML agents, world models, or claim verification; score=1.0
