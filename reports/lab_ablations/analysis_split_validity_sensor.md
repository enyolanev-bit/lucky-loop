...
| **Claims supported** | 2.0 ± 0.0 (n=3) | 2.0 ± 0.0 (n=3) | 0.0 (ON−OFF) | ✅ OUI |
| **Claims blocked** | 3.0 ± 0.0 (n=3) | 3.0 ± 0.0 (n=3) | 0.0 (ON−OFF) | ✅ OUI |
| Runtime total (s) | 0.3257 ± 0.0036 (n=3) | 0.3138 ± 0.0021 (n=3) | -0.0119 (jitter, hors verdict) — within noise | ❌ non (jitter) |
| Runs jusqu'au 1er supported | 2.0 ± 0.0 (n=3) | 2.0 ± 0.0 (n=3) | — | indicatif |
...
|---|---|---|---:|---:|---:|---:|---|
| ON | `reports/lab_ablations/split_validity_sensor/on_run1` | qwen_agentworld | 4 | 0.3254 | 2 | 3 | False |
| ON | `reports/lab_ablations/split_validity_sensor/on_run2` | qwen_agentworld | 4 | 0.3215 | 2 | 3 | False |
| ON | `reports/lab_ablations/split_validity_sensor/on_run3` | qwen_agentworld | 4 | 0.3302 | 2 | 3 | False |
| OFF | `reports/lab_ablations/split_validity_sensor/off_run1` | plumbing_not_called | 4 | 0.3154 | 2 | 3 | False |
| OFF | `reports/lab_ablations/split_validity_sensor/off_run2` | plumbing_not_called | 4 | 0.3151 | 2 | 3 | False |
| OFF | `reports/lab_ablations/split_validity_sensor/off_run3` | plumbing_not_called | 4 | 0.3108 | 2 | 3 | False |
