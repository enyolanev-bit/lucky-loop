...
|---|---|---|---:|---|---|---:|---|---|
| run_001 | logistic_regression | no pre-compute world-model prediction | 0.9778 | no | not predicted | 1.27s | no | no world-model prediction was made before compute |
...
| run_003 | logistic_regression | no pre-compute world-model prediction | 1.0000 | no | not predicted | 0.01s | no | no world-model prediction was made before compute |
...
| run_006 | top_model_verification | no pre-compute world-model prediction | 0.9956 | no | not predicted | 38.57s | no | no world-model prediction was made before compute |
