...
|---|---|---|---:|---|---|---:|---|---|
| run_001 | logistic_regression | no pre-compute world-model prediction | 0.9778 | no | not predicted | 0.35s | no | no world-model prediction was made before compute |
...
| run_006 | random_forest | no pre-compute world-model prediction | 1.0000 | no | not predicted | 0.30s | no | no world-model prediction was made before compute |
| run_007 | gradient_boosting | no pre-compute world-model prediction | 0.9556 | no | not predicted | 0.76s | no | no world-model prediction was made before compute |
