...
|---|---|---|---:|---|---|---:|---|---|
| run_001 | logistic_regression | accuracy around 0.90-0.97 | 0.9510 | yes | under 5 | 0.88s | yes |  |
...
| run_003 | random_forest | accuracy around 0.90-0.98 | 0.9580 | yes | under 10 | 0.76s | yes |  |
| run_004 | gradient_boosting | accuracy around 0.90-0.98 | 0.9510 | yes | under 15 | 0.53s | yes |  |
| run_005 | svc | accuracy around 0.90-0.99 | 0.9860 | yes | under 10 | 0.02s | yes |  |
| run_006 | top_model_verification | accuracy around 0.90-0.99 | 0.9706 | yes | under 45 | 29.83s | yes |  |
| run_007 | verification_sweep | accuracy around 0.85-0.98 | 0.9615 | yes | under 35 | 25.67s | yes |  |
